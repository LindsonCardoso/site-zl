    ...
    <section className="section position-relative" id="about">
      ...
      <Container>
        <Row className="align-items-center">
          ...
          <h1 className="mb-4 font-weight-normal text-center text-light line-height-1_4">Melhor plataforma de gestão online <br /> para seu negócio.<span className="text-primary font-weight-medium"> ZLTech</span></h1>
              <br/>
              <p className=" mb-4 pb-3 text-light text-center">
